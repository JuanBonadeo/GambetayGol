  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/admin/productos/nuevo" className="bg-[#38bdf8] text-black px-4 py-2 rounded font-medium hover:bg-[#0284c7]">Nuevo Producto</Link>
      </div>
            ...
            {productos.map((p: any) => (
              <tr key={p.id} className="hover:bg-gray-800/50">
                ...
                <td className="px-6 py-4 border-l border-gray-800 flex justify-center gap-4">
                  <Link href={`/admin/productos/${p.id}`} className="text-blue-400 hover:text-blue-300">Editar</Link>
